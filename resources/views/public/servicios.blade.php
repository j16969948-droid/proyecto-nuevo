...
<div id="cartBar" class="fixed bottom-0 left-0 w-full bg-white border-t shadow-2xl z-50 hidden">
    ...
    <div class="max-w-7xl mx-auto px-6 py-4">
        ...
        <div id="cartItems" class="flex flex-wrap gap-4 mb-4">
        ...
        <div class="flex items-center justify-between border-t pt-4">
            ...
            <button class="bg-indigo-600 hover:bg-indigo-500 text-white px-6 py-2 rounded-lg font-semibold transition">
